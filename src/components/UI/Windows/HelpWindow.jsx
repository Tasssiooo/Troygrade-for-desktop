...
const HelpWindow = () => {
  return (
    <main
      className="min-w-full bg-gradient-to-t min-h-full from-[#082836] to-[#041c27]"
      id="help-window"
    >
      ...
      <section className="Step">
        <h2>
          <span className="step-number">2.</span> After the dialog open, select
        ...
        <h3 className="mx-5 my-2">
          <span className="step-number">2.1.</span> The files will be organized
          like this
        </h3>
        ...
        <figure>
          <figcaption>
            ...
            <ul>
              ...
              <li>
                Write the code in a .txt file and save in a selected directory.
              </li>
              <li>Delete files from the list.</li>
            </ul>
          </figcaption>
          <img src={screenshot6} width={390} height={150} alt="File handlers" />
        </figure>
      </section>
      <section className="Step">
        <h2>
          <span className="step-number">5.</span> After clicking on the convert
